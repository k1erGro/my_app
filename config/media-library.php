...
return [
     ...
     *
     * Keep this option disabled if using Media Library Pro livewire (https://medialibrary.pro)
     */
     ...
     * the Media Library Pro Vue and React livewire to move uploaded files
