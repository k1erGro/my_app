...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow-md rounded-lg p-8">
            <form action="{{ route('admin.update', auth()->user()->getKey()) }}" method="POST" class="space-y-4"
                ...
                <div>
                    @if(auth()->user()->hasMedia('avatars'))
                        ...
                        <img src="{{ auth()->user()->getFirstMediaUrl('avatars') }}" alt="Аватар"
        ...
        <div class=" mt-5 bg-white shadow-md rounded-lg p-8">
            <form action="{{ route('admin.update_password', auth()->user()->getKey()) }}" method="POST"
                  class="space-y-4">
                @csrf
                @method('patch')
