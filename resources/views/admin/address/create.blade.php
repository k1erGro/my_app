...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Добавить новый адрес</h2>
        ...
        <div class="bg-white shadow-md rounded-lg p-8">
            <form action="{{ route('admin.address.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                @csrf
