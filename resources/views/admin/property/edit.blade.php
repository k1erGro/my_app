...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Обновить характеристику</h2>
        ...
        <div class="bg-white shadow-md rounded-lg p-8">
            <form action="{{ route('admin.property.update', $property->getSlug()) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                @csrf
                @method('patch')

                <div>
                    <label class="block text-sm font-medium text-gray-700">Название категории</label>
                    <input type="text" name="name" value="{{ $property->getName() }}" required
